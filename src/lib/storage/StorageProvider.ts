...
export default interface IStorageProvider {
     ...
     */
    loadCards: (setId: number, cardIds: string[]) => ThunkAction<void, IAppState, void, Action>;

    /**
     * Loads the study state for the specified set
     * If a session is ongoing it will be reset
     */
    loadStudyState: (setId: number) => ThunkAction<void, IAppState, void, Action>;

    /**
     * Adds a new card to the deck
     * Returns the id of the newly added card
     */
    addCard: (setId: number, afterCard?: IFlashCard) => ThunkAction<string, IAppState, void, Action>;

    /**
     * Deletes the specified card
     */
    deleteCard: (setId: number, cardId: string) => ThunkAction<void, IAppState, void, Action>;
     ...
     */
    addSet: (set?: Partial<IFlashCardSet>) => ThunkAction<number, IAppState, void, Action>;
     ...
     */
    getExportUri: (setId: number) => string;

    /**
     * Checks whether the specified set exists
     */
    setExists: (setId: number, callback: (setExists: boolean) => void) => void;

    /**
     * Updates the filtered cards for the specified set
     */
    filterCards: (setId: number, filter: IFlashCardFilter) => ThunkAction<void, IAppState, void, Action>;
